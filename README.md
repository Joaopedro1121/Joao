<meta charset="UTF-8">
 ...
 <body>
     <header class="container text-center">
         <img src="[img/avatar-perfil.png](https://i0.statig.com.br/bancodeimagens/78/pt/gs/78ptgsfeddfh638dkkzya5p3y.jpg)" alt="avatar do joao" class="rounded-circle" width="150" height="150"
             srcset="">
         <p class="lead">Eu sou joao </p>
     <header class="container">
         <img src="[img/avatar-perfil.png](https://s2-ge.glbimg.com/GKuOFY_62G89DJrllpb2nJMGuqA=/0x0:1024x683/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_bc8228b6673f488aa253bbcb03c80ec5/internal_photos/bs/2025/m/4/lwUwHoQeK1zuX8iziXCQ/gettyimages-2209830090.jpg" alt="avatar do joao" srcset="">
         <p>Eu sou joao_</p>
